...
class PrepareGaussianHostGuest:
    ...
    def __init__(self, guest_pdb, host_qm_pdb, n_processors, memory, charge, multiplicity, functional, basis_set, optimisation, frequency, add_keywords_I, add_keywords_II, add_keywords_III, gauss_system_out_file, fchk_system_out_file, host_guest_input):
        self.guest_pdb = guest_pdb
        self.host_qm_pdb = host_qm_pdb
        self.n_processors = n_processors
        self.memory = memory
    ...
    def write_input(self):   
        ...
        df_1.columns = ['atom']
        df_3 = df[['x_coord', 'y_coord', 'z_coord']]
        df_2 = pd.Series(["-1"] * len(df), name='decide_freeze') 
